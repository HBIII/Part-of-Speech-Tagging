...
def hmm_test():
    ...
    test_delta = np.array([[3.5000e-01, 1.3600e-01, 0.0000e+00, 0.0000e+00, 1.1136e-05, 1.1136e-05, 0.0000e+00],
               [1.5000e-01, 3.2000e-02, 4.6400e-03, 2.7840e-04, 3.3408e-05, 1.1136e-05, 8.9088e-07]])

    print("Your forward function output:", delta)
    print("Test forward function output:", test_delta)

    gamma = model.backward(Osequence)
    test_gamma = np.array([[1.6896e-06, 3.8400e-06, 6.4000e-05, 2.0000e-03, 1.4000e-02, 2.0000e-02, 1.0000e+00],
               [1.9968e-06, 1.1520e-05, 1.9200e-04, 3.2000e-03, 2.2000e-02, 6.0000e-02, 1.0000e+00]])

    print("Your backward function output:", gamma)
    print("Test backward function output:", test_gamma)

    prob1 = model.sequence_prob(Osequence)
    test_prob1 = 8.908800000000002e-07

    print("Your sequence_prob function output:", prob1)
    print("Test sequence_prob function output:", test_prob1)

    prob2 = model.posterior_prob(Osequence)
    test_prob2 = np.array([[0.6637931, 0.5862069, 0., 0., 0.175, 0.25, 0.],
               [0.3362069, 0.4137931, 1., 1., 0.825, 0.75, 1.]])

    print("Your posterior_prob function output:", prob2)
    print("Test posterior_prob function output:", test_prob2)
    ...
    print("Test likelihood_prob function output:", test_prob3)

    viterbi_path = model.viterbi(Osequence)
    test_viterbi_path = ['1', '1', '2', '2', '2', '2', '2']

    print('Your viterbi function output: ', viterbi_path)
    print('Test viterbi function output: ', test_viterbi_path)
...
def speech_tagging_test():
    ...
    print("Test total accuracy: ", 0.7761904761904762)
